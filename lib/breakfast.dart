    ...
    return Scaffold(
      ...
      body: Builder(
        builder: (context) {
          ...
          return Column(
            children: [
              Expanded( // Use Expanded to allow SingleChildScrollView to take all available space
                      ...
                      if (snapshot.hasData) {
                        return GridView.builder(
                          ...
                          gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                            crossAxisCount: screenSize.width > 600 ? 4 : 1, // Adjust number of columns based on screen width
