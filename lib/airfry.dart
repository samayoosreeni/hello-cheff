...
class AirfryerPage extends StatefulWidget {
  const AirfryerPage({super.key});

  @override
  State<AirfryerPage> createState() => _AirfryerPageState();
}

class _AirfryerPageState extends State<AirfryerPage> {
  @override
