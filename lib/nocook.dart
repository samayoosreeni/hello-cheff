...
class NoCookPage extends StatefulWidget {
  const NoCookPage({super.key});

  @override
  State<NoCookPage> createState() => _NoCookPageState();
}

class _NoCookPageState extends State<NoCookPage> {
  @override
